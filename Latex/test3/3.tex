...
并且此时有边界条件:
\begin{center}
$\displaystyle \lim\limits_{x \to a^-}\psi(x)=\lim\limits_{x\to a^+}\psi(x)$
\end{center}
这样可得:
\begin{center}
$\displaystyle Ae^{ika}+Be^{-ika}=Fe^{ika}+Ge^{-ika} $  (1)
\end{center}
...
$\displaystyle \frac{\mathrm{d}\psi}{\mathrm{d}x}\bigg|^{a+\epsilon}_{a-\epsilon}=-\frac{2m}{\hbar^2}\bigg[E\psi(a)\displaystyle\int^{a+\epsilon}_{a-\epsilon}\mathrm{d}x-\alpha\psi(a)\bigg]$\\
$\displaystyle \frac{\mathrm{d}\psi}{\mathrm{d}x}\bigg|^{a+\epsilon}_{a-\epsilon}=-\frac{2m}{\hbar^2}[E\psi(a)(2\epsilon)-\alpha\psi(a)]$ , 令$\epsilon \to 0$\\
$\displaystyle \frac{\mathrm{d}\psi}{\mathrm{dx}}\bigg|^{-a^+}_{-a^-}=\frac{2m\alpha}{\hbar^2}\psi(a)=0$\\
$\displaystyle \frac{2m\alpha}{\hbar^2}\psi(a)=\lim\limits_{x \to a^+}\frac{\mathrm{d}\psi}{\mathrm{d}x}-\lim\limits_{x \to a^-}\frac{\mathrm{d}\psi}{\mathrm{d}x}$\\
$\displaystyle ik(Fe^{ika}-Ge^{-ika})-ik(Ae^{ika}-Be^{-ika})=\frac{2m\alpha}{\hbar^2}(Ae^{ika}+Be^{-ika})$   (2)\\
\end{center}
由(1)(2)式求出F和G的表达式，
最终可以得到
\begin{center}
$\displaystyle \left\{\begin{matrix} F=\frac{k\hbar^2-im\alpha}{k\hbar^2}A-\frac{im\alpha}{k\hbar^2}e^{-2ika}B
...
$\begin{bmatrix}
  ...
  \end{bmatrix}
  \begin{bmatrix}
    \displaystyle \frac{k\hbar^2-im\alpha}{k\hbar^2} &-\frac{im\alpha}{k\hbar^2}e^{-2ika} \\
    \displaystyle \frac{im\alpha}{k\hbar^2}e^{2ika} &\frac{k\hbar^2+im\alpha}{k\hbar^2}
  \end{bmatrix}
  =\begin{bmatrix}
    A\\
    B
...
M=M_2 M_1=
\begin{bmatrix}
  \displaystyle \frac{(k\hbar^2-im\alpha)^2+m^2\alpha^2e^{4ika}}{k^2\hbar^4}&\frac{-im\alpha(k\hbar^2-im\alpha)e^{-2ika}-im\alpha(k\hbar^2+im\alpha)e^{2ika}}{k^2\hbar^4}\\
  \displaystyle \frac{im\alpha(k\hbar^2-im\alpha)e^{-2ika}+im\alpha(k\hbar^2+im\alpha)e^{2ika}}{k^2\hbar^4}&\frac{(k\hbar^2+im\alpha)^2+m^2\alpha^2e^{-4ika}}{k^2\hbar^4}
\end{bmatrix}
$
则
